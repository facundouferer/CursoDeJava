...
class Cliente {
    ...
    public boolean equals(Object obj) {
        //esto es un castin del objeto obj para que se nos permita la comparaci�n del segund if anidado

        Cliente other = (Cliente) obj; // casting de objeto

        /*
         * instanceof nos permite determinar si el objeto obj que recibe �sta funci�n como
