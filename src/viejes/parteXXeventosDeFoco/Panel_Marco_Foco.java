package viejes.parteXXeventosDeFoco;
...
class Panel_Marco_Foco extends JPanel {
	...
	class EventosDeFoco implements FocusListener {
		...
		public void focusLost(FocusEvent e) {
			...
			if (e.getSource() == campoTexto01) {
				System.out.println("EL CUADRO 1 PERDI� EL FOCO.");
			}

			if (e.getSource() == campoTexto02) {
				System.out.println("EL CUADRO 2 PERDI� EL FOCO.");
			}

			if (e.getSource() == campoTexto03) {
				System.out.println("EL CUADRO 3 PERDI� EL FOCO.");
			}
