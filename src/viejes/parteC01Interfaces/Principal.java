package viejes.parteC01Interfaces;
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        Personas empleadoParaCastear = new Profesores(25147789, "Sabrina", "TUP"); // DOWNCASTING o casting expl�cito 1)
                                                                                   // hago Upcasting

        profesores[1] = (Profesores) empleadoParaCastear; // DOWNCASTING o casting expl�cito 2) logro el DownCasting
...
abstract class Personas {
    /*
     * Empleado es una clase abstracta porque tien por lo menos un m�todo abstracto
