package viejes.parteC02InterfaceConActionListener;
...
public class Ptincipal {
    public static void main(String[] args) {
        /*
         * 1) Se creo una variable del timpo Timer y tambi�n se importe import
         * java.util.Timer para traerla
         *
...
/*
 * 2) creamos la clase que implementa ActionListener y por lo tanto, como es
 * interface
 * debemos implementar los metodos que nos pide. por suerte es s�lo uno.
 */

class TemporizadorOyente implements ActionListener {

    /*
     * 3) Este m�todo se ejecutar, cada vez que ocurre una acci�n o evento.
     */
