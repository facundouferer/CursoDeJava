package viejes.parteB04PrincipioDeSustitucion;
...
public class Principal {
    public static void main(String[] args) {
         ...
         * Entonces ?(y) debe ser verdad para los objetos y del tipo S donde S, es un
         * subtipo de T.
         *
         * O sea que:
        ...
        empleados[1] = new Profesor(25147789, "Sabrina", "ISI"); // Esto lo podemos hacer por el principio de
                                                                 // sustituci�n.
