package viejes.parteA05Arreglos;
...
class tp2Ejercicio01 {
	...
	public static void main(String[] args) {
		 ...
		 * Desarrollar un programa que pida al usuario que introduzca 10 n�meros enteros
		 * por consola.
		 * Los n�meros introducidos se almacenar�n en un array.
		 * El programa imprime en consola cu�ntos n�meros negativos, positivos y valores
		 * 0 hay en el array.
		 */
		int positivos = 0;
		int negativos = 0;
		...
		for (int i = 0; i < 10; i++) {
			// bucle va tomando los ingresos de teclado del usuario y los colocar en el
			// arreglo
		...
		System.out
				.print("hay " + ceros + "ceros, " + positivos + " n�meros positivos y " + negativos + " n�meros negativos");
