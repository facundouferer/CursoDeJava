package parteE04ColeccionesIteradores;
...
class Banco {
	...
	public static void main(String[] args) {
		...
		/*
		 * debemos re-asignar al iterador para poder
		 * inicializarlo nuevamente, ya que el recorrido 
		...
		/*
		 * no se puede eliminar por medio de un foreach
		 * porque no se puede leer un elemento y a la vez 
		 * eliminarlo 
		 */
