...
class inicio {
	...
	public static void main (String args[]) {
		...
		/**
         * Crear un profesor indicando el Nombre, Apellido y Nro de Legajo, el cual debe poder ingresarse
        ...
        /**
         * Reescribir el método toString de una materia para listar sus datos
		 */

		System.out.println(LaboratorioDeComputacion2.toString());

        /**
         * Eliminar un estudiante de una materia indicando su número de legajo
		 */
        ...
        /**
         * Modificar todos los datos de un Profesor y devolver una excepción con el mensaje
		 *  "ERROR: Eso no parece ser un número de legajo" si se coloca letras en el número de legajo el cual debe
		 * ser sólo números enteros.
