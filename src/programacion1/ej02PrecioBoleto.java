...
public class ej02PrecioBoleto {
    ...
    public static void main(String[] args) {
        ...
        int km = input.nextInt(); // Leemos el número de kilómetros ingresado por el usuario

        double precio = km * 10.50; // Calculamos el precio del boleto multiplicando el número de kilómetros por el precio por kilómetro

        System.out.println("El precio del boleto es de: Bs/." + precio); // Mostramos el precio del boleto al usuario
    }
}
